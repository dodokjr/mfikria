...
function Music() {
  ...
  const musicAPI = [
    ...
    {
      songName: 'GET OUT MY FACE X NIRVANA FULL SENYUM GEMOY',
      songArtist: 'None',
      songSrc: './assets/15.GET OUT MY FACE X NIRVANA FULL SENYUM GEMOY.mp3',
      songAvatar: './assets/logo.png'
    },
    {
    ...
    {
      songName: 'Best Acoustic Japanese Song 🎸 Relaxing Japanese Acoustic Music',
      songArtist: 'None',
      songSrc: './assets/22.Best Acoustic Japanese Song 🎸 Relaxing Japanese Acoustic Music.mp3',
      songAvatar: './assets/logo.png'
    },
    {
      songName: 'Rasah Bali',
