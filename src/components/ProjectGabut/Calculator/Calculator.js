...
import { electricConstantDependencies, evaluate, round } from "mathjs";
...
function Calculator()
{
    ...
    {
        if (answer === "Input Yang Anda Masukan salah") return;
        ...
        } catch (error)
        {
            result =
                error.message === "Brackets are not balanced!"
                    ...
                    : "Input Yang Anda Masukan salah"; //error.message;
        }
